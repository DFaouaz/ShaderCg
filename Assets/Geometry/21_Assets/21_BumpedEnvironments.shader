Shader "CourseShaders/21_BumpedEnvironments"
{
    Properties{
        ...
        _CubeMap("Cube Map", CUBE) = "white" {} // note "CUBE" usage
    }
    SubShader{
        ...
        half _Brightness;
        half _Scale;
        samplerCUBE _CubeMap; // note how cube map textures are referenced by "samplerCUBE"
        ...
        void surf(Input IN, inout SurfaceOutput o) {
            ...
            // Use WorldReflectionVector(struct Input, vec3 surfaceNormal) to get an accurate reflection vector. Don't forget INTERNAL_DATA
