// note: this uses Lambert lighting model. Lambert does not have specular lighting.
Shader "CourseShaders/29_BasicLambert"
{
    Properties{
    ...
    SubShader{
        ...
        CGPROGRAM
        #pragma surface surf Lambert // lighting model goes here
